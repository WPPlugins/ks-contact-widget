...
Author: King Soft
Author URI: http://www.aioresources.net/
	...
	function widget( $args, $instance ) {
		...
		echo $before_widget;
			...
			if ( ! empty( $instance['ks_adress'] ) )
				echo $before_contact_details . apply_filters( 'widget_ks_adress', '<span class="mail">'.$instance['ks_adress'].'</span>', $instance, $this->id_base ) . $end_contact_details;

			if ( ! empty( $instance['ks_phone'] ) )
				echo $before_contact_details . apply_filters( 'widget_ks_phone', '<span class="phone"><a href="tel:'.$instance['ks_phone'].'">'.$instance['ks_phone'].'</a></span>', $instance, $this->id_base ) . $end_contact_details;

			if ( ! empty( $instance['ks_fax'] ) )
				echo $before_contact_details . apply_filters( 'widget_ks_fax', '<span class="fax">'.$instance['ks_fax'].'</span>', $instance, $this->id_base ) . $end_contact_details;

			if ( ! empty( $instance['ks_twitter'] ) )
				echo $before_contact_details . apply_filters( 'widget_ks_twitter', '<span class="twitter_icon">'.$instance['ks_twitter'].'</span>', $instance, $this->id_base ) . $end_contact_details;
